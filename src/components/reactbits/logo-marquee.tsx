...
const FACE =
  "inline-flex h-20 shrink-0 items-center gap-3 whitespace-nowrap rounded-2xl px-5 text-[0.82rem] font-medium tracking-[-0.01em] text-navy/70";

const HIT =
  "outline-none transition-colors duration-150 hover:text-navy focus-visible:bg-teal/[0.07] focus-visible:text-navy focus-visible:shadow-[inset_0_0_0_1px_var(--color-teal)]";
  ...
  return (
    ...
    >
      <div
        ...
        className="overflow-y-hidden py-2 outline-none focus-visible:bg-teal/[0.07] focus-visible:shadow-[inset_0_0_0_1px_var(--color-teal)]"
      >
        <div
          ref={trackRef}
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[#f4fafb] to-transparent"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-[#f4fafb] to-transparent"
      />
    </section>
  );
}
